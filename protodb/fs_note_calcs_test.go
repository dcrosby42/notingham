...
func Test_newRelFilePath(t *testing.T) {
	t.Run("returns a file path relative to the given base dir", func(t *testing.T) {
		...
		note := &db.Note{Content: "The Note Title", Id: "some_id"}
